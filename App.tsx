...
const App: React.FC = () => {
    ...
    return (
        <div className="h-screen w-full flex flex-col bg-slate-950 text-white overflow-hidden relative font-sans">
            ...
            {/* CONTENT */}
            <div className="flex-grow relative overflow-hidden bg-zinc-100 flex flex-col" style={{ backgroundImage: 'radial-gradient(#e4e4e7 1px, transparent 1px)', backgroundSize: '20px 20px' }}>
