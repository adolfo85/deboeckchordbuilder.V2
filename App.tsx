            ...
            <div className="flex-grow relative overflow-hidden bg-[#0f1014] flex flex-col">
                ...
                <div className={`absolute inset-0 flex flex-col transition-transform duration-300 ${viewMode === 'editor' ? 'translate-x-0' : '-translate-x-full'}`}>
                    <div className="flex-grow relative flex flex-col items-center justify-center overflow-hidden" ref={fretboardContainerRef}>
                        <div className="z-40 mb-4"><div className="bg-slate-900 border-2 border-slate-600 rounded-xl px-8 py-3 shadow-2xl flex flex-col items-center min-w-[200px]"><span className="text-[10px] uppercase font-bold mb-1 text-slate-400">Acorde</span><div className="text-3xl font-black text-white tracking-tight">{detectedChord || <span className="text-slate-600">---</span>}</div></div></div>
