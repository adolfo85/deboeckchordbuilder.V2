        ...
        <div className="h-screen w-full flex flex-col bg-slate-950 text-white overflow-hidden relative font-sans">
            ...
            <div className="flex-grow relative overflow-hidden bg-white flex flex-col">
                ...
                <div className={`absolute inset-0 flex flex-col transition-transform duration-300 ${viewMode === 'editor' ? 'translate-x-0' : '-translate-x-full'}`}>
                    <div className="flex-grow relative flex flex-col items-center justify-start pt-6 overflow-y-auto" ref={fretboardContainerRef}>
                        <div className="z-40 mb-4 mt-4"><div className="bg-white border border-slate-200 rounded-lg px-8 py-3 shadow-xl flex flex-col items-center min-w-[200px]"><span className="text-[10px] uppercase font-bold mb-1 text-slate-400">Acorde</span><div className="text-3xl font-black text-slate-900 tracking-tight">{detectedChord || <span className="text-slate-300">---</span>}</div></div></div>
