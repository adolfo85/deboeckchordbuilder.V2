...
export const Fretboard: React.FC<FretboardProps> = ({ 
  ...
  return (
    <div className="w-full h-full flex flex-col justify-center bg-[#0f172a] relative shadow-2xl overflow-hidden">
      <div className="absolute inset-0 bg-[#0f172a]"></div>

      <div 
        ref={scrollRef}
        className="horizontal-scroll w-full overflow-x-auto overflow-y-hidden relative z-10 flex items-center py-10 px-4"
